...
export const defaultHomepageContent: HomepageContent = {
  hero: {
    ...
    ], buttonLabel: 'تبرع وساهم معنا', buttonHref: '/',
  },
  about: {
  ...
  donation: { badge: 'عطاؤك يصل إلى من يحتاجه', title: 'تبرعك يصنع فرقاً حقيقياً', description: 'بدعمك نستطيع الاستجابة للاحتياجات الإنسانية وتقديم المساعدة للأسر الأكثر احتياجاً في قطاع غزة.', image: '/DonationBanner.webp', buttonLabel: 'تبرع الآن', buttonHref: '/' },
  ...
  partners: {
    ...
    items: [{ name: 'الإغاثة الإسلامية', logo: '/partners/islamic-relief.webp' }, { name: 'الصندوق العربي للإنماء الاقتصادي والاجتماعي', logo: '/partners/arab-fund-new.webp' }, { name: 'المصرف العربي للتنمية الاقتصادية في أفريقيا (BADEA)', logo: '/partners/badea-new.webp' }, { name: 'الصندوق الكويتي للتنمية الاقتصادية العربية', logo: '/partners/kuwait-fund-new.webp' }, { name: 'MedGlobal', logo: '/partners/medglobal.webp' }, { name: 'جمعية بيتنا للتنمية والتطوير المجتمعي', logo: '/partners/bcd.webp' }, { name: 'برنامج الأمم المتحدة الإنمائي (UNDP)', logo: '/partners/undp-new.webp' }, { name: 'شبكة المنظمات الأهلية الفلسطينية (PNGO)', logo: '/partners/pngo-new.webp' }],
