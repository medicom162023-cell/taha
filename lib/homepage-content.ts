...
export const defaultHomepageContent: HomepageContent = {
  ...
  projects: {
    ...
    items: [
      ...
      { title: 'توفير المياه النظيفة ودعم المجتمعات', category: 'المياه والإصحاح', description: 'تدخلات ميدانية لتحسين الوصول إلى المياه الآمنة ودعم التجمعات السكانية الأكثر تضرراً.', image: '/project.png' },
      { title: 'تعزيز قدرات المؤسسات والمجتمعات المحلية', category: 'التنمية المجتمعية', description: 'برامج تنموية تعزز قدرات المؤسسات المحلية وتدعم المبادرات المجتمعية الأكثر احتياجاً.', image: '/alliance-ghadaq-capacity.jpg' },
    ], buttonLabel: 'عرض كافة المشاريع', buttonHref: '/projects',
  },
  impact: {
    eyebrow: 'الإغاثة والتنمية من أجل المجتمع', title: 'نعمل لدعم المجتمعات وتعزيز قدرتها على الصمود', image: '/project.png',
  ...
  donation: { badge: 'عطاؤك يصل إلى من يحتاجه', title: 'تبرعك يصنع فرقاً حقيقياً', description: 'بدعمك نستطيع الاستجابة للاحتياجات الإنسانية وتقديم المساعدة للأسر الأكثر احتياجاً في قطاع غزة.', image: '/DonationBanner.png', buttonLabel: 'تبرع الآن', buttonHref: '/donate' },
