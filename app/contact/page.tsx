          ...
          <div className="grid items-start gap-8 lg:grid-cols-[442px_1fr] lg:gap-[66px]">
            <aside className="order-2 space-y-3 lg:order-1">
              ...
              <div className="flex min-h-[54px] items-center justify-center gap-2 bg-white px-5">
                ...
                <SocialIcon label="إنستغرام" href="https://www.instagram.com/"><svg viewBox="0 0 24 24" className="h-5 w-5 fill-none stroke-current stroke-2"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" className="fill-current stroke-0"/></svg></SocialIcon>
                <SocialIcon label="فيسبوك" href="https://www.facebook.com/"><svg viewBox="0 0 24 24" className="h-5 w-5 fill-current"><path d="M14 8h3V4.2c-.5-.1-2.2-.2-4-.2-3.7 0-6.2 2.3-6.2 6.4V14H3v4.3h3.8V24h4.7v-5.7h3.9L16 14h-4.5v-3.2C11.5 9.5 11.9 8 14 8Z"/></svg></SocialIcon>
                <SocialIcon label="إكس" href="https://x.com/"><svg viewBox="0 0 24 24" className="h-4 w-4 fill-current"><path d="M18.2 2H22l-8.3 9.5L23.5 22h-7.7l-6-7.9L2.9 22H-1l8.9-10.2L-1.5 2h7.9l5.4 7.1L18.2 2Zm-1.4 18h2.1L5.2 3.9H3L16.8 20Z"/></svg></SocialIcon>
              </div>
            </aside>
