...
export default function CommunityImpact() {
  ...
  return (
    <section className="bg-white py-14 font-[Alexandria] sm:py-20 lg:py-[139px]">
      <div className="mx-auto max-w-[1088px] px-5 lg:px-0">
        <div dir="ltr" className="grid items-start gap-10 lg:grid-cols-[540px_440px] lg:gap-[108px]">
          <motion.div
            ...
            className="relative order-1 h-[280px] min-w-0 overflow-hidden rounded-[8px] min-[390px]:h-[330px] sm:h-[420px] lg:col-start-1 lg:row-start-1 lg:h-[480px] lg:w-[540px]"
          >
            <Image
              src={impact.image}
              alt={impact.title}
          ...
          >
            <span className="mb-5 inline-flex flex-col items-start gap-[10px] text-[22px] font-bold leading-[34px] text-[#51c698] sm:mb-[27px] sm:text-[24px]">
              {impact.eyebrow}
